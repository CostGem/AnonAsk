...
# Текста сообщений
welcome_message =
    👋 Приветствуем в новостном боте Первой школы!
    ...
    📝 Перед началом использования Вам необходимо пройти регистрацию и выбрать псевдоним, который закрепится за Вашим аккаунтом, чтобы оставаться инкогнито.

    📃 Не забывайте о соблюдении правил, которые закреплены в описании канала.

    ✨ Удобного пользования!

start_message = 👋 Приветствуем в новостном боте Первой школы!
